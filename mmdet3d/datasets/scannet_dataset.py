...
class ScanNetDatasetRPN(Custom3DDataset):
    ...
    def get_ann_info(self, index):
        ...
        if info['annos']['gt_num'] != 0:
            ...
            gt_labels_3d = np.zeros((gt_bboxes_3d.shape[0], ), dtype=np.int64) # RPN
        else:
    ...
    def load_annotations(self, ann_file):
        ...
        ann_file = mmcv.load(ann_file, file_format='pkl')
        # print(len(ann_file))
        # print(ann_file[0].keys())
        # print(ann_file[0]['annos'].keys())
        # print(ann_file[0]['annos']['index'])
        # print(ann_file[0]['annos']['class'])
        # print(len(ann_file[0]['annos']['class']))
        # for anno in ann_file:
        #     anno['annos']['class'] = [0 for _ in anno['annos']['class']]
        #     anno['annos']['name'] = ['object' for _ in anno['annos']['name']]
        # exit()
        return ann_file

@DATASETS.register_module()
class Front3dDatasetRPN(Custom3DDataset):
    r"""ScanNet Dataset for Detection Task.
